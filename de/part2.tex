...
\subtitle{Teil 2: Strukturierte Dokumente und Mehr \\
...
\begin{itemize}
\item In Teil 1 haben wir die Befehle und Umgebungen kennen gelernt, um Text und mathematische Formeln zu setzen.
\item Jetzt lernen wir, wie man mit Befehlen und Umgebungen strukturierte Dokumente erstellt. 
\item Du kannst (wie in Teil 1) die neuen Befehle in Overleaf ausprobieren: 
\end{itemize}
\vskip 2em
\begin{center}
\fbox{\href{\wlnewdoc{basics.tex}}{%
Klicke hier, um das Beispiel in \wllogo{} zu öffnen}}
\\[1ex]\scriptsize{}
...
\begin{itemize}{\small
\item Gib' \LaTeX{} den Titel (\cmdbs{title}) und die Autorennamen (\cmdbs{author}) in der Präambel.
\item Nutze daraufhin \cmdbs{maketitle} im Dokument, um den Titel zu plazieren und erstellen.
\item Nutze die \bftt{abstract}-Umgebung, um einen Abstract zu erstellen.
}\end{itemize}
