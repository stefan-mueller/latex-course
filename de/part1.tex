...
\begin{itemize}
\item Erweiterungen für Papers, Präsentationen, Poster, Lebensläufe etc.
\end{itemize}
\end{itemize}
\end{frame}
...
\item Ein Befehl kann verschiedene Outputs (abhängig von Umgebung) produzieren. 
\begin{exampletwouptiny}
...
\item Erweiterungen (packages) lädt.
\end{itemize}
\item In Teil 2 lernen wir, wie man \LaTeX{}  nutzt, um in strukturierten Dokumenten Kapitel, Querverweise, Grafiken, Tabellen und ein Literaturverzeichnis erstellt.
\end{itemize}
\end{frame}
