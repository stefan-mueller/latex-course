...
\usepackage[utf8]{inputenc} % Umlaute darstellen
\begin{document}

% Hinweise:
% 1. Du solltest das amsmath-Package nutzen
% 2. Das Symbol für unendlich ist \infty
% 3. Um Umlaute darzustellen, nutze die Erweiterung \usepackage[utf8]{inputenc}
